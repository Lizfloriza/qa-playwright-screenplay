...
- Name: api/users.spec.ts >> Users API — CRUD >> PUT /api/users/:id >> should fully update a user
- Location: tests/api/users.spec.ts:101:9

# Error details

```
Error: Path "name" not found in response body
```
