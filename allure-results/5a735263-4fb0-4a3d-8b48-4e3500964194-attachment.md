...
- Name: api/users.spec.ts >> Users API — CRUD >> GET /api/users/:id >> should get user by id
- Location: tests/api/users.spec.ts:51:9

# Error details

```
Error: Path "data.id" not found in response body
```
