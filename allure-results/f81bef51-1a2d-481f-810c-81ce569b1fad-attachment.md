...
- Name: api/users.spec.ts >> Users API — CRUD >> GET /api/users >> should list users on page 1
- Location: tests/api/users.spec.ts:18:9

# Error details

```
Error: Path "page" not found in response body
```
